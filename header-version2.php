...
<body <?php body_class(); ?> data-lang="<?php echo esc_attr( $lang ); ?>" data-time="<?php echo esc_attr( $cal_time ); ?>" data-disweek="<?php echo esc_attr($calendar_dis_weekend); ?>">
    ...
    <div class="ovatheme_container_<?php echo esc_attr(ireca_get_current_width_site()); ?> <?php echo esc_attr($bg['bg_class']); ?> woocommerce">
		...
		<header class="ovatheme_header_version2 header_m <?php  echo esc_attr( $bg['bg_class'] ); ?>">
			...
			<div class="top d-none d-lg-block">
				<div class="container">
					<div class="row d-flex header2_top">
						...
						<?php if( is_active_sidebar('header2_left_logo') ){ ?>
							<?php dynamic_sidebar('header2_left_logo'); ?>
						<?php } ?>
						</div>

						<div class="col-md-4">
						<a href="<?php echo esc_url(home_url('/')); ?>" class="navbar-brand d-none d-lg-block py-0 px-0">
						...
						<?php if( is_active_sidebar('header2_right_logo') ){ ?>
							<?php dynamic_sidebar('header2_right_logo'); ?>
						<?php } ?>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<nav class="navbar navbar-expand-lg py-0 px-5">
								...
								<a href="<?php echo esc_url(home_url('/')); ?>" class="navbar-brand  d-block d-lg-none py-0">
		...
		<?php if( $bg['bg_url'] ){ ?>
			<div class="header_img header_version2" style="background: url( <?php echo esc_url( $bg['bg_url'] ); ?> )" >
